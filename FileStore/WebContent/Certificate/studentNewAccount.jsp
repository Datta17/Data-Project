					...
					<div class="col-sm-11 wfid_temp192648">
						<div class="row wfid_temp192667">
							...
							<div class="col-sm-2 wfid_temp192683">
								...
								<a href="login.jsp" id="login">login</a> <br> <a
									href="studentNewAccount.jsp" id="createAccount">Create
									Account</a>
							...
							<div class="col-sm-10 wfid_temp192683">
								<div class="it-section wfid_temp192699">
									...
									<div class="row main" style="margin: 0 25% 0 25%;"
										id="createAccount1">
										...
										<div class="panel panel-primary">
											<div class="panel-heading">
												<h3 class="panel-title" style="text-align: center">Create
													User New Account</h3>
											</div>
											<div class="panel-body">
												...
												<div class="col-sm-12">
													...
													<form action="Controller?mode=studentNewAccount"
														name="form" method="post" onSubmit="formValidation()">
														...
														<div class="label-field-pair">
															...
															<input name="securityQuestion" type="text"
																id="securityQuestion" class="form-control" required />

														</div>


														<div class="label-field-pair">
															<label>Answer<span class="required">*</span></label> <input
																name="answer" type="text" id=""
																answer""
													 class="form-control" required />
