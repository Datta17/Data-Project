					...
					<div class="col-sm-11 wfid_temp192648">
						<div class="row wfid_temp192667">
							...
							<div class="col-sm-2 wfid_temp192683">
								...
								<a href="ligin.jsp" id="login">login</a>
								<br>
...
<span  id="log">You are successfully logged out!</span>
<%-- 
<input type="text" value="<%=err %>" id="data"> --%>
                         ...
                         <div class="panel-body">
										...
										<div class="col-sm-12">
											...
											<form action="controller?mode=login" method="post">
												...
												<a href="forgotPassword.jsp">	<input type="button" class="btn "
