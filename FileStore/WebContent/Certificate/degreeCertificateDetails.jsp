			...
			<div
				...
				<div class="row">
					<div class="col-sm-8">
						...
						<h5 style="text-align: center; margin-top: 1%"> Online Student Facilities
...
<form action="Controller?mode=degreeCertificate1" method="post" >
									<div class="row">
										<div class="col-sm-4">
...
<!-- <div class="row">
 ...
 -->
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="label-field-pair">
												<label>Student Seat Number :</label>
											</div>
										</div>
										<div class="col-sm-4">
									...
									<div class="row">
										...
										<div class="col-sm-4">
											<label class="radio-inline"> <input type="radio"
												name="examMonth" value="April/May">April/May
											</label> <label class="radio-inline"> <input type="radio"
